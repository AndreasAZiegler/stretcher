...
public:
    ...
    */
    ...
    /**
     * @brief Adds an x-data point.
     * @param x_value value of the x-data point
     */
    void AddXData(double x_value);

    /**
     * @brief Adds an y-data point.
     * @param y_value value of the y-data point
     */
    void AddYData(double x_value);

    /**
     * @brief Prepares the recently added data points to be plotted.
     */
