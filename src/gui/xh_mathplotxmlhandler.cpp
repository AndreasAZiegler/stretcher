...
#include "xh_mathplotxmlhandler.h"

// Register with wxWidgets' dynamic class subsystem.
IMPLEMENT_DYNAMIC_CLASS(mpWindowXmlHandler, wxXmlResourceHandler)

mpWindowXmlHandler::mpWindowXmlHandler()
