...
void MyFrame::startup(void){
  ...
  m_PreloadSpeedMmSpinCtrl->SetDigits(4);
  m_PreloadSpeedMmSpinCtrl->SetRange(0.001, 11);
  m_OneStepStressForceVelocitySpinCtrl->SetDigits(4);
  m_OneStepStressForceVelocitySpinCtrl->SetRange(0.001, 1000);
  ...
  m_OneStepDistanceVelocitySpinCtrl->SetDigits(4);
  m_OneStepDistanceVelocitySpinCtrl->SetRange(0.001, 1000);
  ...
  m_ContinuousStressForceVelocitySpinCtrl->SetDigits(4);
  m_ContinuousStressForceVelocitySpinCtrl->SetRange(0.001, 1000);
  ...
  m_ContinuousDistanceVelocitySpinCtrl->SetDigits(4);
  m_ContinuousDistanceVelocitySpinCtrl->SetRange(0.001, 1000);
