...
class ExperimentValues : virtual public UpdatedValuesReceiver
{
  ...
  protected:
    ...
    //std::shared_ptr<std::vector<double>> m_DistanceGrpahValues;															/**< Vector containing only the distance values. */
    ...
    std::shared_ptr<std::vector<double>> m_ForceStressGraphValues;														/**< Vector containing only the stress/force - distance values */
    double m_CurrentForceStressGraphValue;														/**< Current force/stress value for the graph. */
    double m_CurrentDistanceGraphValue;																	/**< Current distance value for the graph. */
